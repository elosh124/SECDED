...
#endif
            VL_FATAL_MT("src/1_cycle_part/testbench.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__R_DATA = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__E_DATA);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__D_DATA);
    vlSelf->testbench__DOT__ERR = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__D_ERR = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__S_ERR = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__N_DATA);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__NOISE);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__dut_encoder__DOT__BUFFER);
    vlSelf->testbench__DOT__dut_decoder__DOT__SYNDROME = VL_RAND_RESET_I(8);
    VL_RAND_RESET_W(72, vlSelf->testbench__DOT__dut_decoder__DOT__MASK);
