...
VL_INLINE_OPT VlCoroutine Vtestbench___024root___eval_initial__TOP__Vtiming__2(Vtestbench___024root* vlSelf) {
    ...
    co_await vlSelf->__VdlySched.delay(0x25ULL, nullptr, 
                                       "src/1_cycle_tot/testbench.sv", 
                                       60);
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__dut_decoder__DOT__BUFFER[0U] 
        = (vlSelf->testbench__DOT__NOISE[0U] ^ vlSelf->testbench__DOT__dut_encoder__DOT__BUFFER[0U]);
    vlSelf->testbench__DOT__dut_decoder__DOT__BUFFER[1U] 
        = (vlSelf->testbench__DOT__NOISE[1U] ^ vlSelf->testbench__DOT__dut_encoder__DOT__BUFFER[1U]);
    vlSelf->testbench__DOT__dut_decoder__DOT__BUFFER[2U] 
        = (vlSelf->testbench__DOT__NOISE[2U] ^ vlSelf->testbench__DOT__dut_encoder__DOT__BUFFER[2U]);
...
#endif
            VL_FATAL_MT("src/1_cycle_tot/testbench.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("src/1_cycle_tot/testbench.sv", 1, "", "Active region did not converge.");
            }
